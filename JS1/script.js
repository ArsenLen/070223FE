...
// let newDegree = 15;
/*
    функция, которая еще раз через три часа запрашивает погоду
*/
// degree = newDegree
///
// degree = 50

// Задача. Запросить два числа у пользователя поочередно. 
// Если первое число больше второго, в консоли выводить больше.
// Если они равны, то выводить введенное число. 10 == 10, console.log('10')
// Если второе больше первого, то в консоли выводить "меньше". Если первое меньше второго.
// const PI = 3.14
// const number = +prompt('Введите первое число')
// const number2 = +prompt('Введите второе число')
// console.log(typeof PI) // выведем тип данных // string // number
...
// prompt по умолчанию возвращает строку "100" "50"
// +prompt() - вернет число 100
// typeof - возвращает тип данных значение
